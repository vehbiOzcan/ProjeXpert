...
class _SignupPageWidgetState extends State<SignupPageWidget> {
  ...
  Future<void> _registerUser() async {
    final url = Uri.parse('http://10.0.2.2:15000/api/auth/register');
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData['success'] == true) {
        await PreferencesManager().setAccessToken(responseData['access_token']);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Sunucu hatası!')),
      );
    }
  }
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(15, 20, 15, 0),
                      child: FFButtonWidget(
                        onPressed: _registerUser, // Yeni fonksiyonu kullan
                        text: 'Kayıt Ol',
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40,
